# 20 by 20
n_string = '08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
...
n_array = Array.new(20, lambda { Array.new }).map { |i| i.call }

# construct "two-dimensional" array
n_string.split(/\s+/).map.with_index do |x, i|
  n_array[i % 20] << x.to_i
end
